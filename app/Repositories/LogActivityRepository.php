...
class LogActivityRepository
{
	 ...
	 * @return int
	 */
	public static function getLogActivitiesCount(array $filters = [], $search_string = null)
	{
	 ...
	 * @return array
	 */
	public static function getAvailableSubjectTypesForMeta()
	{
		$result = [];
	...
	public static function getAvailableLogNamesForMeta()
	{
		$result = [];
		$types = LogActivity::query()
			->groupBy('log_name')
	 ...
	 * @return Builder
	 */
	private static function getLogActivitiesQuery(array $filters = [], $search_string = null)
	{
		$query = LogActivity::query();
