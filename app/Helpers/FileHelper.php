...
class FileHelper
{
	 ...
	 * @throws \Exception
	 */
	public function uploadExternalFilesByToStorage($external_urls, $storage_disk): array
	{
		$uploaded_files = [];
	 ...
	 * @throws \Exception
	 */
	public function uploadFileFromStringInBase64($base64_string, $storage_disk): string
	{
	...
	{
		return md5(random_int(0, 1000000) . microtime());
	}
