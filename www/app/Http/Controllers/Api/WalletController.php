...
//			'balance.required' => 'Enter wallet balance',
	 ...
	 * @throws \Exception
	 */
    public function getWalletById($wallet_id): JsonResponse
    {
	 ...
	 * @throws \Exception
	 */
    public function updateById(Request $request, $wallet_id): JsonResponse
    {
	    $wallet = Wallet::query()->find($wallet_id);
	    if ($wallet === null) {
	 ...
	 * @throws \Exception
	 */
	public function deleteById($wallet_id): JsonResponse
	{
		$wallet = Wallet::query()->find($wallet_id);
		if ($wallet === null) {
			throw new NotFoundHttpException('Wallet not found');
